...
from .views import RegistrationGenericAPIView, CustomTokenObtainPairView, VerifyUserToken, UserChangePassword, PsswordRecoveryView
...
urlpatterns = [
    ...
    path('password_recovery/<str:email>/',PsswordRecoveryView.as_view(), name="password_recovery"),
